...
function login_form()
{
    ...
    <form method="post" action="?a=login" name="loginform">
      <label for="login_input_username" style="margin: auto; text-align: center;">Username</label>
      <input id="login_input_username" class="login_input form-control" style="width: 30%; margin: auto;" type="text" name="user_name" value="' . $user_name . '" required>
      <br>
      <label for="login_input_password" style="margin: auto; text-align: center;">Password</label>
      <input id="login_input_password" class="login_input form-control" type="password" style="width: 30%; margin: auto;" name="user_password" autocomplete="off" required>
      <br>
      <br>
      <input type="submit"  name="a" value="Login" class="btn btn-primary" />
      <br>
      <br>
      <a class="btn" href="?a=register" class="btn btn-light">Register New Account</a>
    </form>';
...
function register_form()
{
    ...
    <form method="post" action="?a=register" name="registerform">
      ...
      <label for="login_input_username" style="margin: auto; text-align: center;">Username</label>
      <input id="login_input_username" class="form-control" style="text-align: center; width: 50%; margin: auto" type="text" pattern="[a-zA-Z0-9]{2,64}" name="user_name" value="' . $user_name . '" style="margin: auto; text-align: center;" required>
      <br>
      <!-- the email input field uses a HTML5 email type check -->
      <label for="login_input_email" style="margin: auto; text-align: center;">Email Address</label>
      <input id="login_input_email" class="form-control" type="email" style="text-align: center; width: 50%; margin: auto;" name="user_email" style="margin: auto; text-align: center;" value="' . $user_email . '" required>
      <br>
      <label for="login_input_password_new" style="margin: auto; text-align: center;">Password</label>
      <input id="login_input_password_new" class="form-control" style="text-align: center; width: 50%; margin: auto;" type="password" name="user_password_new" pattern=".{6,}" required autocomplete="off" >
      <br>
      <label for="login_input_password_repeat" style="margin: auto; text-align: center;">Confirm Password</label>
      <input id="login_input_password_repeat" class="form-control" style="text-align: center; margin: auto; width: 50%;" type="password" name="user_password_repeat" pattern=".{6,}" required autocomplete="off">
      <br>
      <br>
      <input type="submit"  name="a" value="Register" class="btn btn-primary">
      <br>
      <br>
      <a class="btn btn-warning" href="?a=login">&laquo; Back to Login Page</a>
    </form>';
